...
//               // Limpia el estado del usuario en SharedPreferences
//               final prefs = await SharedPreferences.getInstance();
//               await prefs.remove('username'); // Elimina el usuario actual
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              // Lógica para cerrar sesión
              final prefs = await SharedPreferences.getInstance();
              await prefs.remove('username'); // Limpia el estado del usuario
              Navigator.pushReplacementNamed(context, '/login'); // Navega al login
            },
          ),
        ],
